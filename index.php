...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card">
      <img src="otto.jpeg" class="card-img-top" height="400px">
      <div class="card-body">
        <h3 class="card-title"> A Man Called Otto</h3>
        <p class="card-text">film A Man Called Otto bercerita tentang pria paruh baya bernama Otto yang hampir mengakhiri hidupnya sendiri. Ia mengalami kesialan saat istrinya meninggal dan Otto terpaksa pensiun dari pekerjaannya. Otto yang memiliki sifat pemarah, memutuskan untuk bunuh diri. Belum sempat melancarkan aksinya, ia kedatangan sebuah keluarga yang menjadi tetangga barunya. Mereka sangat ramai hingga mengganggu Otto. Tapi siapa sangka, justru tetangga itulah yang menyelamatkan hidup Otto yang hampir berakhir begitu saja.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="john.jpeg" class="card-img-top" height="400px">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="dungeons.jpeg" class="card-img-top" height="400px">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="bed rest.jpeg" class="card-img-top" height="400px">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="Mindcage 5.jpeg" class="card-img-top" height="400px">
      <div class="card-body">
...
Saat Mary menggali informasi tentang The Artist yang gila tapi brilian, ia dan Jake justru terjebak dalam permainan kucing tikus yang kejam. Mereka harus berpacu dengan waktu agar tetap selangkah lebih maju dari The Artist dan sang peniru.</p>
  ...
  <div class="col">
    <div class="card">
      <img src="creed 111.png" class="card-img-top" height="400px">
      <div class="card-body">
